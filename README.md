# Google 2011 Webpage Clone

This project is a recreation of Google's homepage and sign-in experience as it appeared in **2011**, based on screenshots from the [Web Design Museum](https://www.webdesignmuseum.org/).
...
- Uses the **Google 2011 logo**: `images/google-logo.png`.
- Favicon included: `icon/favicon (9).ico`.
...
2. Use the search box and buttons to simulate Google search.
3. Click **Sign in** to test the sign-in modal.
...
# Example:
<img width="990" height="600" alt="google-2012" src="https://github.com/user-attachments/assets/43fdc888-0993-454d-b4ab-5cc9bd391880" />
